...
public class PurchaseOrderServiceImpl implements PurchaseOrderService {
    ...
    private Bin allocateBin(Integer warehouseId, BigDecimal incomingWeight, String productName) {
        ...
        // Khóa toàn bộ các Bins đang active trong kho. Tránh việc 2 PO được duyệt cùng 1 lúc 
        // tính toán cùng 1 mức trống của Bin và cùng nhét số lượng lớn vào làm tràn Bin.
