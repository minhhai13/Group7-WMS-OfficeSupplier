...
public class GoodsIssueNoteServiceImpl implements GoodsIssueNoteService {
    ...
    private String postGINForSO(GoodsIssueNote gin, Map<Integer, Integer> issuedQtyMap) {
        ...
        for (GoodsIssueDetail ginDetail : gin.getDetails()) {
            ...
            if (inputIssuedQty > 0) {
                ...
                // Lấy StockBatch kèm theo khóa ForUpdate để đảm bảo không bị 2 Storekeeper xuất hàng cùng lúc ghi đè nhau làm hụt Qty.
    ...
    private String postGINForTO(GoodsIssueNote gin, Map<Integer, Integer> issuedQtyMap) {
        ...
        for (GoodsIssueDetail ginDetail : gin.getDetails()) {
            ...
            if (inputIssuedQty > 0) {
                ...
                // Deduct source stock
                // [RACE CONDITION FIX]: Khóa dòng Batch Nguồn trong luồng TO để từ từ xuất kho.
                ...
                // [RACE CONDITION FIX]: Khóa dòng Batch Nơi Nhận của luồng TO để nhích dần lượng QtyInTransit lên
    ...
    private Bin allocateBin(Integer warehouseId, BigDecimal incomingWeight, String productName) {
        // [RACE CONDITION FIX]: Vượt MaxWeight trong luồng BackOrder
